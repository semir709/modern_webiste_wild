...
const ArticleCard = ({ title, date, image, url }) => {
  return (
    <Link to={url}>
      <div className="group mb-5 flex h-fit cursor-pointer flex-col border-t-2 border-black py-5 sm:flex-row">
        ...
        <div className="flex w-full flex-col justify-between uppercase text-customBlack sm:w-8/12 sm:ps-5">
